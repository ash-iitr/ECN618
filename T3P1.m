% Complete the MATLAB code to generate the magnitude and spectrogram of 5G PDSCH of bandwidth 90 MHz and carries data in single bandwidth parts (BWP) having numerologies 0  by considering  size of 50 RBs and following information:
% a) SLIV = 41
